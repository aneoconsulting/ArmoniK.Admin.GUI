...
import { GrpcParamsService, ListResultsRequest, ResultsClient } from '@armonik.admin.gui/shared/data-access';
...
describe('GrpcResultsService', () => {
  ...
  it('should create a list of specified request params', () => {
    const state: ClrDatagridStateInterface = {
      ...
      sort: {
        by: ListResultsRequest.OrderByField.ORDER_BY_FIELD_SESSION_ID as unknown as ClrDatagridComparatorInterface<number>,
        reverse: true
      },
      filters: [
        {
  ...
  it('should create a default list of request options', () => {
    ...
    expect(result).toEqual(new ListResultsRequest({
      page: 0,
      pageSize: 10,
      sort:{
