...
import { ApplicationsClient, GrpcParamsService, ListApplicationsRequest } from '@armonik.admin.gui/shared/data-access';
...
describe('GrpcApplicationsService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [GrpcApplicationsService, ApplicationsClient, GrpcParamsService],
    });
  ...
  it('should create a list of specified request params', () => {
    const state: ClrDatagridStateInterface = {
      ...
      sort: {
        by: ListApplicationsRequest.OrderByField.ORDER_BY_FIELD_NAMESPACE as unknown as ClrDatagridComparatorInterface<number>,
        reverse: true
      },
      filters: [
        {
  ...
  it('should create a default list of request options', () => {
    ...
    expect(result).toEqual(new ListApplicationsRequest({
      page: 0,
      pageSize: 10,
      sort:{
  ...
  it('should create a list of request options', () => {
    ...
    expect(result).toEqual(new ListApplicationsRequest({
      ...
      sort:{
        ...
        direction: ListApplicationsRequest.OrderDirection.ORDER_DIRECTION_DESC
      },
      filter:{
        name: 'Some test name',
        namespace: '',
