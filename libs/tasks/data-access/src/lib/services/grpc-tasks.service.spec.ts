...
import { GrpcParamsService, ListTasksRequest, TasksClient } from '@armonik.admin.gui/shared/data-access';
...
describe('GrpcTasksService', () => {
  ...
  it('should create a list of specified request params', () => {
    const state: ClrDatagridStateInterface = {
      ...
      sort: {
        by: ListTasksRequest.OrderByField.ORDER_BY_FIELD_STARTED_AT as unknown as ClrDatagridComparatorInterface<number>,
        reverse: true
      },
      filters: [
        {
  ...
  it('should create a default list of request options', () => {
    ...
    expect(result).toEqual(new ListTasksRequest({
      page: 0,
      pageSize: 10,
      sort:{
