...
:::{image} https://armonik-public-images.s3.eu-west-3.amazonaws.com/Documentation-GUI/datagrid-toolbar.png
:alt: [Image] Datagrid Toolbar
:align: center
:::
...
:::{note}
More about [columns](./3.columns.md).
:::
...
:::{note}
More about [filters](./6.filtering.md).
:::
