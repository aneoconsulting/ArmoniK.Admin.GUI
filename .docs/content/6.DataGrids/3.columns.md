...
- Redirect you to a [inspection](../5.inspection-page.md) page.
...
This column is only available to [Applications](../7.Data/1.Applications.md), [Partitions](../7.Data/2.Partitions.md) and [Sessions](../7.Data/3.Sessions.md) Datagrids, and display the number of tasks grouped by one or more status.
...
:::{image} https://armonik-public-images.s3.eu-west-3.amazonaws.com/Documentation-GUI/tasks-by-statuses.png
:alt: [Image] Tasks By Statuses
:align: center
:::
