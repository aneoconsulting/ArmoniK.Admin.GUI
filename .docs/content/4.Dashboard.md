...
:::{image} https://armonik-public-images.s3.eu-west-3.amazonaws.com/Documentation-GUI/dashboard-configuration-panel.png
:alt: [Image] Dashboard Configuration Panel
:align: center
:::
...
:::{image} https://armonik-public-images.s3.eu-west-3.amazonaws.com/Documentation-GUI/add-line.png
:alt: [Image] Adding a line
:align: center
:::
...
:::{image} https://armonik-public-images.s3.eu-west-3.amazonaws.com/Documentation-GUI/dashboard-spliting-lines.png
:alt: [Image] spliting lines
:align: center
:::
...
:::{image} https://armonik-public-images.s3.eu-west-3.amazonaws.com/Documentation-GUI/dashboard-reorganizing-lines.png
:alt: [Image] Reorganizing lines
:align: center
:::
