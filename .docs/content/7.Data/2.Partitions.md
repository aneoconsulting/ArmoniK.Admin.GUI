...
:::{image} https://armonik-public-images.s3.eu-west-3.amazonaws.com/Documentation-GUI/partitions-datagrid.png
:alt: [Image] Partitions DataGrid
:align: center
:::
...
:::{image} https://armonik-public-images.s3.eu-west-3.amazonaws.com/Documentation-GUI/partitions-inspection.png
:alt: [Image] Partition Inspection page
:align: center
:::
