...
:::{image} https://armonik-public-images.s3.eu-west-3.amazonaws.com/Documentation-GUI/tasks-datagrid.png
:alt: [Image] Tasks DataGrid
:align: center
:::
...
:::{image} https://armonik-public-images.s3.eu-west-3.amazonaws.com/Documentation-GUI/manage-view-in-logs.png
:alt: [Image] Manage view in logs
:align: center
:::
...
:::{image} https://armonik-public-images.s3.eu-west-3.amazonaws.com/Documentation-GUI/tasks-inspection.png
:alt: [Image] Tasks Inspection Page
:align: center
:::
### Navigation

- **See session**: Redirect to the [Session Inspection Page](./3.Sessions.md#inspection-page) of the task session ID.
...
| -------- | -------- | -------- |
| Creating | The Task is currently being created | `Cancel` |
| Dispatched | The Task has been dispatched to ArmoniK | `Cancel` |
| Submitted | The Task has been submitted to the queue | `Cancel` |
| Processing | The Task is currently processing | `Cancel`|
...
| Retried | The Task is currently retrying to run | `Cancel` |
